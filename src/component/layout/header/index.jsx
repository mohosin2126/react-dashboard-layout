...
export default function Header({isOpen,setIsOpen}){
    ...
    return (
        <>
            <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-indigo-400">
                    ...
                    <div className="relative">
                        ...
                        {dropdownOpen && (
                            <>
                                ...
                                <div
                                    className="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl transition duration-150 ease-out transform scale-100 opacity-100">
                                    <a
                                        href="#"
